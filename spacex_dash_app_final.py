...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        all_sites_data = spacex_df[spacex_df['Launch Site'] == entered_site]
        success_count = all_sites_data['class'].sum()  # Assuming you have a 'class' column for success
        failure_count = len(all_sites_data) - success_count
        fig = px.pie(
